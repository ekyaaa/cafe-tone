            ...
            <div className="min-h-screen bg-[#121212] text-white">
                ...
                <div className="fixed left-0 top-0 w-60 h-full bg-[#0a0a0a] p-4 overflow-y-auto">
                    ...
                    <nav className="space-y-1">
                        <Link href={route('admin.home')} className="flex items-center px-4 py-3 rounded-lg bg-[#282828] text-white">
                            <svg className="w-6 h-6 mr-4" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/>
                            </svg>
                            <span>Home</span>
                        </Link>
                        <Link href={route('admin.explore')} className="flex items-center px-4 py-3 rounded-lg hover:bg-[#282828] text-gray-400 hover:text-white transition">
                            <svg className="w-6 h-6 mr-4" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"/>
                            </svg>
                            <span>Explore</span>
                        </Link>
                        <Link href={route('admin.library')} className="flex items-center px-4 py-3 rounded-lg hover:bg-[#282828] text-gray-400 hover:text-white transition">
                            <svg className="w-6 h-6 mr-4" fill="currentColor" viewBox="0 0 24 24">
